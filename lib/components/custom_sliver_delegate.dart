...
class CustomSliverDelegate extends SliverPersistentHeaderDelegate {
  ...
  bool?
      showaligncontainerwidget; //the widget that is align/stacked at the top of the curve container
  Widget? widget1; //widget that will be postitoned at the top of the search bar
  Widget?
      widget2; //widget that will be postitoned at the bottom of the search bar
        ...
        if (showHorizontalScrollList == true)
          Align(
            ...
            child: Opacity(
              ...
              child: Padding(
                padding:
                    EdgeInsets.only(top: 30, left: 30, right: 0, bottom: 0),
                    ...
                    itemBuilder: (context, index) {
                      return Padding(
                          padding: const EdgeInsets.only(
                              top: 125.0, left: 10, right: 10, bottom: 110),
                          child: Container(
                            height: 110,
                ...
                child: Opacity(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                        top: 33.9 * percent, left: 30, right: 30, bottom: 0),
                    child: Container(
                      height: 90,
